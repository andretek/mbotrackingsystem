...
if (isset($_POST["submit"])) {
   ...
   $query= mysqli_query($conn,"SELECT * FROM `nydd` WHERE (obr, office_code)= ('$OBR', '$OFFICECODE')");
   ...
   $sql = "INSERT INTO `nydd`(`id`, `office_code`, `name_office`, `payee`, `discription`, `account_code`, `obr`, `amount`) VALUES (NULL,'$OFFICECODE','$OFFICENAME','$PAYEE','$DISCRIPTION','$ACCOUNTCODE','$OBR','$AMOUNT')";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: nydd.php?msg=New record created successfully");
   } else {
